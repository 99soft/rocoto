...
public final class ConfigurationModuleTestCase {
    ...
    public void loadINIConfiguration() {
        this.configurationModule.loadConfiguration(HierarchicalINIConfiguration.class, "/com/rocoto/configuration/ibatis.ini");
    }

    @Test(groups = "load")
    public void loadXMLConfiguration() {
        this.configurationModule.loadConfiguration(XMLConfiguration.class, "/com/rocoto/configuration/proxy.xml");
    }

    @Test(groups = "load")
    public void loadPListConfiguration() {
        this.configurationModule.loadConfiguration(PropertyListConfiguration.class, "/com/rocoto/configuration/memcached.plist");
    }
