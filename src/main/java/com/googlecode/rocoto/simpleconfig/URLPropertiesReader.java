 ...
 * @since 3.3
 */
final class URLPropertiesReader implements PropertiesReader {
     ...
     * @param classLoader
     */
    public URLPropertiesReader(String classpathResource, ClassLoader classLoader, boolean isXML) {
     ...
     * @param file
     */
    public URLPropertiesReader(File file, boolean isXML) {
        if (file == null) {
     ...
     * @param url
     */
    public URLPropertiesReader(URL url, boolean isXML) {
        if (url == null) {
    ...
    public Iterator<Entry<String, String>> read() throws Exception {
        ...
        try {
            ...
            return new PropertiesIterator(null, properties);
        } finally {
